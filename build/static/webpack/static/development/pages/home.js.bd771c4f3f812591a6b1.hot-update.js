...
function createDataWithoutUnits(name, units, mandatory, type, data, location) {
  return {
    name: name,
    mandatory: mandatory,
    type: type,
...
var customersProblemsAndRequestsData = [createDataWithoutUnits('Water Conservation', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i29'), createDataWithoutUnits('Energy Savings', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i30'), createDataWithoutUnits('Bio-contamination problems', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i31'), createDataWithoutUnits('Scale Precipitation problems', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i32'), createDataWithoutUnits('Silica Related Problems', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i33'), createDataWithoutUnits('Chemical Elimination', 'Yes/No', MANDATORY, TYPES.SELECT, ['', 'Yes', 'No'], 'i34')];
...
//# sourceMappingURL=home.js.bd771c4f3f812591a6b1.hot-update.js.map