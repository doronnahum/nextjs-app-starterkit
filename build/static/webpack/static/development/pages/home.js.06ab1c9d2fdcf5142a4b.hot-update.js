...
var getCalculateNewValues = function getCalculateNewValues(key, value, tableValues) {
  ...
  if (isOneOf(keys, ['d10', 'd11'])) {
    // d12
    newValues['d12'] = getValue('d10', newValues) - getValue('d11', newValues);
    keys.push('d12');
  }

  if (isOneOf(keys, ['d21', 'd22'])) {
    // d23
    newValues['d23'] = getValue('d21', newValues) - getValue('d22', newValues);
    keys.push('d23');
  }
  ...
  switch (type) {
    case _data__WEBPACK_IMPORTED_MODULE_3__["TYPES"].NUMERIC:
      return __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_4__["default"], {
        id: row.location,
        label: "Number",
        value: tableValues[row.location] || 0,
    ...
    case _data__WEBPACK_IMPORTED_MODULE_3__["TYPES"].RANGE:
      return __jsx(_material_ui_core_Slider__WEBPACK_IMPORTED_MODULE_5__["default"], {
        defaultValue: null //Math.floor((row.min + row.max) / 2)
        ,
...
//# sourceMappingURL=home.js.06ab1c9d2fdcf5142a4b.hot-update.js.map