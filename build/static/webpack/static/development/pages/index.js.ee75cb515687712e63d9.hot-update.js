...
var renderValueType = function renderValueType(field, updateTablesValues, tableValues, classes) {
  var type = field.type;
  ...
  switch (type) {
    ...
    case _data__WEBPACK_IMPORTED_MODULE_3__["TYPES"].RANGE:
      return __jsx(_material_ui_core_Slider__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        onChange: function onChange(e, val) {
          return onChangeSlider(e, val, field.location, updateTablesValues, tableValues);
        },
    ...
    case _data__WEBPACK_IMPORTED_MODULE_3__["TYPES"].SELECT:
      ...
      }, field.data.map(function (item, i) {
        return __jsx("option", {
          key: i,
          value: item
        }, item);
...
//# sourceMappingURL=index.js.ee75cb515687712e63d9.hot-update.js.map