...
var iOneOf = function iOneOf(keys, arr) {
...
var renderValueType = function renderValueType(row, updateTablesValues, tableValues, classes) {
  ...
  switch (type) {
    ...
    case _data__WEBPACK_IMPORTED_MODULE_3__["TYPES"].RANGE:
      return __jsx(_material_ui_core_Slider__WEBPACK_IMPORTED_MODULE_5__["default"] // defaultValue={0}//Math.floor((row.min + row.max) / 2)
      , {
        ...
        min: row.min,
        max: row.max,
        marks: getMarks(row) // valueLabelDisplay="on"
...
//# sourceMappingURL=home.js.8b3e2a0accb54e69976a.hot-update.js.map