...
var mechanicalPropertiesData = [createRowData('Number of CT (interconnected)', '# (interconnected cooling towers)', MANDATORY, [{
  location: 'd8',
  type: TYPES.RANGE,
  data: {
    min: 0,
...
var operationalPropertiesData = [createRowData('CWR - Cooling Water Return temperature', 'oC', MANDATORY, [{
  location: 'd21',
  type: TYPES.RANGE,
  data: {
    min: 0,
...
var waterOriginData = [createRowData('Water Source', 'Public/Well/River/Reuse', MANDATORY, [{
  location: 'j8',
  type: TYPES.SELECT,
...
var operationCostsData = [createRowData('Chemical costs', '$USD/year', MANDATORY, [{
  location: 'j13',
  type: TYPES.NUMERIC
...
var enironmentalData = [createRowData('Discharge limitations', 'Chlorides (ppm)', MANDATORY, [{
  location: 'j20',
  type: TYPES.NUMERIC
...
var customersProblemsAndRequestsData = [createRowData('Water Conservation', null, MANDATORY, [{
  location: 'i29',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
...
var waterAnalysisData = [createRowData('Conductivity', 'µS/cm', MANDATORY, [{
  location: 'd32',
  type: TYPES.NUMERIC
}, {
  location: 'e32',
...
var thermodynamicCalculationsData = [createRowData('UET treatment cycles of concentration', '#', MANDATORY, [{
  location: 'd47',
  type: TYPES.NOT_EDITABLE
}, {
  location: 'e47',
...
var potentialWaterSavingData = [createRowData('Calculated Water Saving (m3/h)', null, MANDATORY, [{
  location: 'c55',
  type: TYPES.NOT_EDITABLE
...
var predictiveWaterAnalysis = [createRowData('Conductivity', 'µS/cm', MANDATORY, [{
  location: 'd63',
  type: TYPES.NOT_EDITABLE
}, {
  location: 'e63',
...
var sizingFactorsData = [createRowData('Silica Factor', '>15', MANDATORY, [{
  location: 'j47',
  type: TYPES.NOT_EDITABLE
}, {
  location: 'l47',
...
var sizingOfReactorsData = [createRowData('Sizing (# of Reactors)', null, MANDATORY, [{
  location: 'i58',
  type: TYPES.NOT_EDITABLE
}])];
var modelConfigurationData = [createRowData('1X4', null, MANDATORY, [{
  location: 'i62',
  type: TYPES.NOT_EDITABLE
}, {
  location: 'j62',
...
var UETCirculationFlowrateData = [createRowData('minimum flow rate', null, MANDATORY, [{
  location: 'i68',
  type: TYPES.NOT_EDITABLE
...
var theoreticalEnergySavingsData = [createRowData('Electricity Cost', '$USD/kWH', MANDATORY, [{
  location: 'd79',
  type: TYPES.NOT_EDITABLE
...
var ROICalculationData = [createRowData('Potential Water Savings', '$USD/Year', MANDATORY, [{
  location: 'd85',
  type: TYPES.NOT_EDITABLE
...
var UETWorkingParameters = [createRowData('Approx. Electricity Consumption', 'kWH', MANDATORY, [{
  location: 'j79',
  type: TYPES.NOT_EDITABLE
...
//# sourceMappingURL=index.js.af20c0f35f7a4601cc0a.hot-update.js.map