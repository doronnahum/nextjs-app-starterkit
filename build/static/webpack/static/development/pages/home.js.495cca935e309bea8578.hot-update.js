...
var getCalculateNewValues = function getCalculateNewValues(key, value, values) {
  var newValues = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, values, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, key, value)); // All if's here
...
var handleInputChange = function handleInputChange(event, updateTablesValues) {
  var values = {}; // All data here

  var field = event.target.id;
  var newValue = event.target.value;
  var newValues = getCalculateNewValues(field, newValue, values);
  updateTablesValues({
    values: newValues
  });
};
...
//# sourceMappingURL=home.js.495cca935e309bea8578.hot-update.js.map