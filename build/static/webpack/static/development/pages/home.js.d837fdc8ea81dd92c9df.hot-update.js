...
function HeaderCols(props) {
  var data = props.data;
  return __jsx(TableRow, null, data.map(function (title) {
...
function NoDataTableCell(props) {
  ...
  return __jsx(TableRow, null, __jsx(TableCell, {
    align: "left",
    className: className
  }, "no data"));
}
...
//# sourceMappingURL=home.js.d837fdc8ea81dd92c9df.hot-update.js.map