...
function SimpleTable(props) {
  ...
  var onChangeSlider = function onChangeSlider(event, val, location) {
    setValues(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, values, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, location, event.target.value)));
  };
  ...
  var getMarks = function getMarks() {
    ...
    for (var index = data.min; index <= data.max; index + data.ticks) {
      arr.push({
        value: index
      });
    }
...
//# sourceMappingURL=home.js.9c64dc7e166196c8f319.hot-update.js.map