...
var enironmentalData = [createManyValuesData('Discharge limitations', 'Chlorides (ppm)', MANDATORY, [{
  ...
  location: 'j23',
  type: TYPES.NUMERIC
}]), createManyValuesData('Water Source', 'Yes/No', MANDATORY, [{
  location: 'j24',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Water Source', 'Yes/No', MANDATORY, [{
...
var customersProblemsAndRequestsData = [createManyValuesData('Water Conservation', null, MANDATORY, [{
  location: 'i29',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Energy Savings', null, MANDATORY, [{
  location: 'i30',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Bio-contamination problems', null, MANDATORY, [{
  location: 'i31',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Scale Precipitation problems', null, MANDATORY, [{
  location: 'i32',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Silica Related Problems', null, MANDATORY, [{
  location: 'i33',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}]), createManyValuesData('Chemical Elimination', null, MANDATORY, [{
  location: 'i34',
  type: TYPES.SELECT,
  data: ['', 'Yes', 'No']
}])];
...
//# sourceMappingURL=index.js.3224322c046dd03b241f.hot-update.js.map