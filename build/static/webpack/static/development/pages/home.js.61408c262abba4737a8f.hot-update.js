...
function SimpleTable(props) {
  ...
  var onChangeSlider = function onChangeSlider(event, val) {
    //continue here
  ...
  var getMarks = function getMarks() {
    ...
    if (arr.length) {
      arr[0].label = data.min;
      arr[arr.length - 1].label = data.max;
    }
...
//# sourceMappingURL=home.js.61408c262abba4737a8f.hot-update.js.map