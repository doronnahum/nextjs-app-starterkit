...
import { fetchFakeData } from 'src/redux/example/example.actions';
import { getFakeData } from 'src/redux/example/example.selectors';
...
function PublicScreen({
  ...
  return (
    <Paper className={`${classes.root} PublicScreen_screen`}>
      <div className={classes.header}>
        <h2>Hi, i am example of public screen</h2>
      </div>
      {/*
      // --------------------------------------------------------------------
      ...
      <Card className={classes.card}>
        ...
        <div>isAuthenticated ?
          ...
          <span>{isAuthenticated
            ...
            : <Link href={`${ROUTES.SIGNIN_ROUTE}?next=/example/public`}><a>SIGNIN</a></Link>}
          </span>
        </div>
      </Card>
      {/*
